...
test_pipeline = [
    dict(type="LoadPointsFromFile", coord_type="LIDAR", load_dim=5, use_dim=5, backend_args=backend_args),
    dict(type="LoadPointsFromMultiSweeps", sweeps_num=10, test_mode=True, backend_args=backend_args),
    dict(
        ...
        transforms=[
            dict(
                type="GlobalRotScaleTrans", rot_range=[0, 0], scale_ratio_range=[1.0, 1.0], translation_std=[0, 0, 0]
            ),

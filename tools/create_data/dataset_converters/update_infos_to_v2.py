...
def update_nuscenes_infos(pkl_path, out_dir):
    ...
    nusc = NuScenes(version=data_list['metadata']['version'],
    ...
    for ori_info_dict in mmengine.track_iter_progress(data_list):
        ...
        if anns is not None:
            ...
            for instance_id in range(num_instances):
                ...
                center_2d = points_cam2img(center_3d.reshape([1, 3]),
                                           cam2img,
                                           with_depth=True)
...
def generate_kitti_camera_instances(ori_info_dict):
    ...
    ann_infos = get_kitti_style_2d_boxes(ori_info_dict,
                                         occluded=[0, 1, 2, 3],
                                         annos=annos)
...
if __name__ == '__main__':
    ...
    update_pkl_infos(dataset=args.dataset,

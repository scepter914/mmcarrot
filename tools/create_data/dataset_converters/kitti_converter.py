...
def create_kitti_info_file(data_path,
    ...
    kitti_infos_train = get_kitti_image_info(data_path,
                                             training=True,
                                             velodyne=True,
                                             calib=True,
...
def create_waymo_info_file(data_path,
    ...
    waymo_infos_gatherer_trainval = WaymoInfoGatherer(
        ...
        num_worker=workers)
    waymo_infos_gatherer_test = WaymoInfoGatherer(data_path,
                                                  training=False,
                                                  label_info=False,
                                                  velodyne=True,
                                                  calib=True,
...
def get_2d_boxes(info, occluded, mono3d=True):
    ...
    for ann_idx, ann_rec in enumerate(ann_recs):
        ...
        # sensor.
        corners_3d = box_np_ops.center_to_corner_box3d(gt_bbox_3d[:, :3],
                                                       gt_bbox_3d[:, 3:6],
                                                       gt_bbox_3d[:, 6],
                                                       [0.5, 0.5, 0.5],
                                                       axis=1)

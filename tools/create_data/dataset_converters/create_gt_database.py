...
def create_groundtruth_database(
    ...
    if dataset_class_name == "KittiDataset":
        ...
        dataset_cfg.update(
            ...
            pipeline=[
                dict(type="LoadPointsFromFile", coord_type="LIDAR", load_dim=6, use_dim=6, backend_args=backend_args),
                dict(type="LoadAnnotations3D", with_bbox_3d=True, with_label_3d=True, backend_args=backend_args),
            ],
        )
    ...
    def create(self):
        ...
        if self.dataset_class_name == "KittiDataset":
            ...
            dataset_cfg.update(
                ...
                pipeline=[
                    dict(
                        type="LoadPointsFromFile", coord_type="LIDAR", load_dim=4, use_dim=4, backend_args=backend_args
                    ),
                    dict(type="LoadAnnotations3D", with_bbox_3d=True, with_label_3d=True, backend_args=backend_args),
                ],
            )
            ...
            dataset_cfg.update(
                ...
                pipeline=[
                    dict(
                        type="LoadPointsFromFile", coord_type="LIDAR", load_dim=6, use_dim=6, backend_args=backend_args
                    ),
                    dict(type="LoadAnnotations3D", with_bbox_3d=True, with_label_3d=True, backend_args=backend_args),
                ],
            )
